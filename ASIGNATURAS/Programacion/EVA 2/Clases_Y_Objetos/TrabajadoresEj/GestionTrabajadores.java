...
public class GestionTrabajadores {
    ...
    static List<Proyecto> listaProyectosEmpresa = new ArrayList<>();
    static List<Trabajador> listaTrabajadoresEmpresa = new ArrayList<>();
    ...
    /**
     * @return opcion de menú seleccionada. Retorna un 0 si hay que salir de la aplicación.
     */
    ...
    public static void listarTrabajadores() {
        ...
        for (Trabajador trabajador : listaTrabajadoresEmpresa) {
            trabajador.mostrarDatosTrabajador(numeroTrabajador);
        }
    }
}
